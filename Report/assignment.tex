...
\begin{figure}[htbp]
	\centering
	\subfigure[$\rho$]{\includegraphics[width=.24\linewidth]{figure/ramp/g256/d_line.png}}
	\subfigure[$Ma$]{\includegraphics[width=.24\linewidth]{figure/ramp/g256/Ma_line.png}}
	\subfigure[$p$]{\includegraphics[width=.24\linewidth]{figure/ramp/g256/p_line.png}}
	\subfigure[$T$]{\includegraphics[width=.24\linewidth]{figure/ramp/g256/T_line.png}}
	\caption{\label{fig:ramp256line}$384\times256$网格下压缩拐角计算结果（$y=10$上变量分布），实线为精确解，虚线为数值解}
\end{figure}

\begin{figure}[htbp]
	\centering
	\subfigure[$\rho$]{\includegraphics[width=.45\linewidth]{figure/ramp/g256/d.png}}
	\subfigure[$Ma$]{\includegraphics[width=.45\linewidth]{figure/ramp/g256/Ma.png}}
	\subfigure[$p$]{\includegraphics[width=.45\linewidth]{figure/ramp/g256/p.png}}
	\subfigure[$|\nabla\rho|$]{\includegraphics[width=.45\linewidth]{figure/ramp/g256/schlieren.png}}
